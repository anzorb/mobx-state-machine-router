  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-600 mb-8">
        This is a simple page to demonstrate navigation. Notice that you can't
        navigate to Product Detail from here directly - the state machine only
        allows transitions defined in the configuration.
      </p>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-8">
        ...
        <p className="text-gray-600 mb-6">
          This is a demo application for the MobX State Machine Router library.
        </p>
        ...
        <div className="flex gap-4">
          ...
          <a
            href="https://www.npmjs.com/package/@mobx-state-machine-router/core"
            target="_blank"
            rel="noopener noreferrer"
